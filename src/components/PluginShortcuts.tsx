 ...
 * 已启用插件（Chroma / SignalRGB）在旁边显示快捷按钮 + 连接状态小灯，点击直达其控制台。
 */

import { motion } from 'framer-motion'
import { Blocks, Lightbulb, RadioTower } from 'lucide-react'
import { openChromaConsole, openPluginCenter, openPluginConsole } from '../services/pluginStore'
