...
function SemanticPreview({ settings, active }: { settings: SignalRgbSettings; active: boolean }) {
  ...
  return <canvas ref={canvasRef} className="block aspect-[16/7] w-full rounded-md border border-white/10 bg-black" aria-label="HyperPlayer 音频语义预览" />;
}
            ...
            <div className="flex min-h-16 items-center justify-between gap-3 px-3 py-2 sm:px-5">
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="truncate text-[10px] text-cyan-200/50">HYPERPLAYER EFFECT CONSOLE</p>
                </div>
              ...
              <div className="grid min-w-0 grid-cols-1 gap-3 p-3 lg:grid-cols-[minmax(0,1.35fr)_minmax(300px,.65fr)] sm:p-4">
                <div className="min-w-0 space-y-3">
                  <section className="border p-4" style={PANEL}>
                    <div className="mb-3 flex items-center justify-between gap-3"><div><h3 className="text-sm font-semibold text-white/90">音频语义预览</h3><p className="mt-0.5 text-[10px] text-white/35">HyperPlayer 原创预览，不代表 SignalRGB 的逐像素输出</p></div><Activity className="h-4 w-4 text-cyan-300" /></div>
                ...
                <aside className="min-w-0 space-y-3">
                  ...
                  <section className="border p-4" style={PANEL}>
                    <h3 className="text-sm font-semibold text-white/90">SignalRGB 内部参数</h3><p className="mt-2 text-[11px] leading-relaxed text-white/45">灵敏度、衰减、尺寸、亮度、速度、镜像与方向由 SignalRGB Effect UI 管理。HyperPlayer 控制台不会伪装成这些原生参数的远程编辑器。</p>
                  </section>
                </aside>
              </div>
            )}
              ...
              <div className="grid min-w-0 grid-cols-1 gap-3 p-3 lg:grid-cols-2 sm:p-4">
                <div className="min-w-0 space-y-3">
                  ...
                  <section className="border p-4" style={PANEL}>
                    ...
                    <p className="mt-1 text-[11px] text-white/40">自动应用和恢复只通过 SignalRGB Pro Local API。没有 Pro 时请在 SignalRGB 中手动选择 HyperPlayer。</p>
