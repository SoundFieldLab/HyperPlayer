...
const manifest: PluginManifest = {
  ...
  iconColor: "#19d3c5",
  detail: [
    "HyperPlayer Effect 运行在 SignalRGB 内部，直接读取其原生 engine.audio 数据并渲染当前 SignalRGB 布局中的全部受支持品牌设备。",
    "提供 12 种原创灯光风格；HyperPlayer 只发送播放、节拍、重音、风格与主题等低频语义事件，不向 SignalRGB 传输频谱帧。",
    "Effect 文件可由控制台安装或更新，安装后需要重启 SignalRGB，并在 SignalRGB 中手动选择 HyperPlayer Effect。",
