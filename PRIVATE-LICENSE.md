# HyperPlayer 私有模块许可（Private Module License）

**版权所有（c）2026 IceFireIcer · 保留所有权利。**

> 顶层许可声明（含上游授权声明）见仓库根 [LICENSE](./LICENSE)。
> 本文件为私有模块的**范围与限制细则**。
