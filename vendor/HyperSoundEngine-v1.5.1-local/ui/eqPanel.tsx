...
import type { EqBand, EqMode, HyperSoundEngineParams } from '../src/types'
...
export function EqPanel({ controller, theme }: { controller: HyperSoundEngineParamsController; theme: HyperSoundEngineTheme }) {
