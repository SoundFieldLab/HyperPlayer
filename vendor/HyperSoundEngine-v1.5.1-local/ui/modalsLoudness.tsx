...
export function LoudnessCompModal({ controller, theme, onClose }: { controller: HyperSoundEngineParamsController; theme: HyperSoundEngineTheme; onClose: () => void }) {
...
export function LoudnessNormModal({ controller, theme, onClose }: { controller: HyperSoundEngineParamsController; theme: HyperSoundEngineTheme; onClose: () => void }) {
  const { params, patch } = controller
...
/* 聚合导出 */
export function LoudnessModal({ effectKey: key, controller, theme, onClose }: { effectKey: 'loudnessCompensation' | 'loudnessNormalization'; controller: HyperSoundEngineParamsController; theme: HyperSoundEngineTheme; onClose: () => void }) {
