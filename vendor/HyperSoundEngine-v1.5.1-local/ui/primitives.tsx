...
export function InfoLine({ children, theme }: { children: ReactNode; theme: HyperSoundEngineTheme }) {
  return (
...
export function GlassRangeStyle({ theme }: { theme: HyperSoundEngineTheme }) {
  return (
    <style>
      {`
