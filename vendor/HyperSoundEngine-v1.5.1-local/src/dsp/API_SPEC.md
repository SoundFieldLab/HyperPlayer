# DSP 模块 API 契约（子代理实现规范）

> 本文件是 HyperSoundEngine 各 DSP 模块的**唯一实现契约**。所有子代理严格按此签名实现，
...
## 模块 3：src/dsp/EqChain.ts —— 多段 EQ 级联 + Q 补偿（20 段，核心，技术文档 §1.3）
...
export const SCENE_IDS: string[] // 12 个 id：pop/enhance/jazz/dance/classical/livehouse/studio/warm/dts/vocal-stage/night-bass/heavy-bass
```
12 场景（流行/增强/爵士/舞曲/古典/LiveHouse/录音棚/温暖/DTS浩渺/悠扬舞台/深夜低音/重低音），每个为完整参数快照
