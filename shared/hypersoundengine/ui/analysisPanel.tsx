...
import type { HyperSoundEngineUiBridge, HyperSoundEngineHearingSession } from './bridge'
...
export function AnalysisPanel({ bridge, theme, controller }: { bridge: HyperSoundEngineUiBridge; theme: HyperSoundEngineTheme; controller: HyperSoundEngineParamsController }) {
  ...
  const [hearing, setHearing] = useState<HyperSoundEngineHearingSession | null>(null)
