...
export function ReverbModal({ controller, theme, onClose }: { controller: HyperSoundEngineParamsController; theme: HyperSoundEngineTheme; onClose: () => void }) {
...
export function Surround3dModal({ controller, theme, onClose }: { controller: HyperSoundEngineParamsController; theme: HyperSoundEngineTheme; onClose: () => void }) {
  const { params, patch } = controller
...
export function BassEnhancerModal({ controller, theme, onClose }: { controller: HyperSoundEngineParamsController; theme: HyperSoundEngineTheme; onClose: () => void }) {
  const { params, patch } = controller
...
export function SpatialModal({ effectKey: key, controller, theme, onClose }: { effectKey: 'reverb' | 'surround3d' | 'bassEnhancer'; controller: HyperSoundEngineParamsController; theme: HyperSoundEngineTheme; onClose: () => void }) {
