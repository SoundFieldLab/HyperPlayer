...
export const TAURI_COMMANDS = {
  ...
  neteaseMvPlayback: "netease_mv_playback",
...
function tauriBridge(): TauriBridgeContract {
  ...
  return {
    ...
    async neteaseScrobble(request) { return invoke<NeteaseScrobbleDto>(TAURI_COMMANDS.neteaseScrobble, { request: { songId: request.songId, sourceId: request.sourceId ?? null, playedSeconds: request.playedSeconds } }); },
    ...
    async neteaseMvPlayback(mvId, resolution = 1080) { return invoke<NeteaseMvPlaybackDto>(TAURI_COMMANDS.neteaseMvPlayback, { request: { mvId, resolution } }); },
